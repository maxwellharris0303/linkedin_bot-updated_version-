...
SAMPLE_RANGE_NAME = 'types of employees!A2:B'


indexData = []

interest_type_of_employees = []
...
def main():
    ...
    try:
        ...
        indexData.clear()
        interest_type_of_employees.clear()
        ...
        for row in values:
            ...
            if len(row) >= 2:
                interest_type_of_employees.append('%s' % (row[0]))

        # print(getInterestTypeOFEmployee())
...
def getInterestTypeOFEmployee():
    return interest_type_of_employees
